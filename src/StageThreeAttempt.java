...
//control i formats
public class StageThreeAttempt {
	public static void main(String[] args) {
		...
		//turncounter if even then player 2
		...
		{	
			do{//player one hits player two first
				...
				showBoard2(board2);
				shoot(shoot);
				attempts2++; //attempts2 2 is as it is on board2
				...
				if(hit(shoot,ships2)){
					...
					hint(shoot,ships2,attempts2); //calls hint
		...
		//can this do loop be changed to if to alternate players?
